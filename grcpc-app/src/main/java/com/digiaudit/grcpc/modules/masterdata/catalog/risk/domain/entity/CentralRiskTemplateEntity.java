...
public class CentralRiskTemplateEntity extends CentralDefinitionEntity {
    ...
    private CentralRiskTemplateEntity(UUID id, String code, String title, UUID riskCategoryId,
    ...
    public static CentralRiskTemplateEntity create(UUID id, String code, String title, UUID riskCategoryId,
                                                    String description, int sortOrder, LocalDate validFrom,
                                                    LocalDate validTo, UUID actorId, Instant now) {
        return new CentralRiskTemplateEntity(id, code, title, riskCategoryId, description, sortOrder,
    ...
    public void restoreFromCreate(String title, UUID riskCategoryId, String description, int sortOrder,
    ...
    public void reactivateFromCreate(String title, UUID riskCategoryId, String description, int sortOrder,
                                     LocalDate validFrom, LocalDate validTo, UUID actorId, Instant now) {
        this.riskCategoryId = riskCategoryId;
        this.sortOrder = sortOrder;
    ...
    public UUID getRiskCategoryId() { return riskCategoryId; }
