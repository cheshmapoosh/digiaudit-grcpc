...
public class CentralRiskTemplateQueryService {
  ...
  public CentralRiskTemplateQueryService(
      CentralRiskTemplateRepository repository, CentralRiskMapper mapper) {
  ...
  public List<CentralRiskTemplateSummaryResponse> list(UUID categoryId) {
    var rows =
        categoryId == null
            ...
            : repository.findByRiskCategoryIdAndStatusNotOrderBySortOrderAscTitleAscIdAsc(
                categoryId, MasterDataLifecycleStatus.DELETED);
