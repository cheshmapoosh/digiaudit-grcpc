...
public enum DocumentLinkTargetType {
    ...
    CENTRAL_POLICY_VERSION_SUBPROCESS_SCOPE("CENTRAL_POLICY_SUBPROCESS", true),
    CENTRAL_POLICY_VERSION_CONTROL_SCOPE("CENTRAL_POLICY_CONTROL", true),
    CENTRAL_POLICY_VERSION_REQUIREMENT_SCOPE("CENTRAL_POLICY_REQUIREMENT", true),
