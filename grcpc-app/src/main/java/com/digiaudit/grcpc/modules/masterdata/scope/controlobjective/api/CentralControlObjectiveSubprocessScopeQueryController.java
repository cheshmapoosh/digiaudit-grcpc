...
@RestController
@RequestMapping("/api/master-data/central/control-objectives/{controlObjectiveId}/subprocess-scopes")
public class CentralControlObjectiveSubprocessScopeQueryController {
  private final CentralSubprocessControlObjectiveScopeQueryService queries;

  public CentralControlObjectiveSubprocessScopeQueryController(
  ...
  public List<CentralSubprocessControlObjectiveScopeResponse> list(
    ...
    return queries.listForControlObjective(controlObjectiveId, status, search);
  }
}
