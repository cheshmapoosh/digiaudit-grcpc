...
public interface CentralPolicyRepository extends JpaRepository<CentralPolicyEntity, UUID> {
    List<CentralPolicyEntity> findByStatusNotOrderBySortOrderAscTitleAscIdAsc(MasterDataLifecycleStatus status);
    List<CentralPolicyEntity> findByStatusOrderBySortOrderAscTitleAscIdAsc(MasterDataLifecycleStatus status);
    List<CentralPolicyEntity> findByPolicyGroupIdAndStatusNotOrderBySortOrderAscTitleAscIdAsc(UUID groupId, MasterDataLifecycleStatus status);
