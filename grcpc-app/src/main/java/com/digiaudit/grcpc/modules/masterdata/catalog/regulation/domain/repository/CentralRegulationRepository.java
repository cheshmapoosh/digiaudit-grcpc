...
public interface CentralRegulationRepository extends JpaRepository<CentralRegulationEntity, UUID> {
  List<CentralRegulationEntity> findByStatusNotOrderBySortOrderAscTitleAscIdAsc(
      MasterDataLifecycleStatus status);

  List<CentralRegulationEntity> findByStatusOrderBySortOrderAscTitleAscIdAsc(
      MasterDataLifecycleStatus status);

  List<CentralRegulationEntity> findByRegulationGroupIdAndStatusNotOrderBySortOrderAscTitleAscIdAsc(
