...
public class CentralRegulationGroupEntity extends CentralDefinitionEntity {
    ...
    private CentralRegulationGroupEntity(UUID id, String code, String title, UUID parentGroupId,
    ...
    public static CentralRegulationGroupEntity create(UUID id, String code, String title, UUID parentGroupId,
                                                       String description, int sortOrder, LocalDate validFrom,
                                                       LocalDate validTo, UUID actorId, Instant now) {
        return new CentralRegulationGroupEntity(id, code, title, parentGroupId, description, sortOrder,
