...
@Entity
@Table(name = "central_policy_control_scope")
public class CentralPolicyControlScopeEntity {
  ...
  @JdbcTypeCode(SqlTypes.BINARY)
  @Column(name = "central_control_scope_id", nullable = false, updatable = false, columnDefinition = "RAW(16)")
  ...
  protected CentralPolicyControlScopeEntity() {}
  public static CentralPolicyControlScopeEntity create(UUID policyId, UUID centralControlScopeId,
      LocalDate validFrom, LocalDate validTo, UUID actor, Instant now) {
    CentralPolicyControlScopeEntity row = new CentralPolicyControlScopeEntity();
    row.id = UUID.randomUUID();
    row.policyId = policyId;
    row.centralControlScopeId = centralControlScopeId;
