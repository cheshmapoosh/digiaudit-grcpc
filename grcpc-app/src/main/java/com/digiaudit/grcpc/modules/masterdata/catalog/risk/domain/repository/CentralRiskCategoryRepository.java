...
public interface CentralRiskCategoryRepository
    extends JpaRepository<CentralRiskCategoryEntity, UUID> {
  List<CentralRiskCategoryEntity> findByStatusNotOrderBySortOrderAscTitleAscIdAsc(
      MasterDataLifecycleStatus status);

  List<CentralRiskCategoryEntity> findByStatusOrderBySortOrderAscTitleAscIdAsc(
      MasterDataLifecycleStatus status);

  List<CentralRiskCategoryEntity> findAllByOrderByIdAsc();

  Optional<CentralRiskCategoryEntity> findByIdAndStatusNot(
