...
public interface CentralRegulationGroupRepository
    extends JpaRepository<CentralRegulationGroupEntity, UUID> {
  List<CentralRegulationGroupEntity> findByStatusNotOrderBySortOrderAscTitleAscIdAsc(
      MasterDataLifecycleStatus status);

  List<CentralRegulationGroupEntity> findByStatusOrderBySortOrderAscTitleAscIdAsc(
      MasterDataLifecycleStatus status);

  List<CentralRegulationGroupEntity> findAllByOrderByIdAsc();

  Optional<CentralRegulationGroupEntity> findByIdAndStatusNot(
