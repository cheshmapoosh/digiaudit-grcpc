...
public class CentralRiskCategoryQueryService {
  ...
  public CentralRiskCategoryQueryService(
      CentralRiskCategoryRepository repository, CentralRiskMapper mapper) {
  ...
  public List<CentralRiskCategoryTreeResponse> tree() {
    List<CentralRiskCategoryEntity> entities =
  ...
  private static final class Node {
    ...
    private Node(CentralRiskCategoryEntity entity) {
      this.entity = entity;
    }

    private CentralRiskCategoryTreeResponse response() {
      children.sort(ORDER);
      return new CentralRiskCategoryTreeResponse(
          entity.getId(),
          entity.getCode(),
          entity.getTitle(),
