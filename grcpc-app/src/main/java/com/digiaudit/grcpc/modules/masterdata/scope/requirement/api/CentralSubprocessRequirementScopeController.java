...
@RestController
@RequestMapping("/api/master-data/central/subprocesses/{subprocessId}/requirement-scopes")
public class CentralSubprocessRequirementScopeController {
  private final CentralSubprocessRequirementScopeQueryService queries;

  public CentralSubprocessRequirementScopeController(
