package com.digiaudit.grcpc.modules.masterdata.coverage.riskcontrol.domain.entity;
...
@Entity
@Table(name = "central_subprocess_risk_control_coverage")
public class CentralSubprocessRiskControlCoverageEntity {
  ...
  protected CentralSubprocessRiskControlCoverageEntity() {}
  private CentralSubprocessRiskControlCoverageEntity(UUID id, UUID subprocessId, UUID riskScopeId, UUID controlScopeId, LocalDate validFrom, LocalDate validTo, UUID actorId, Instant now) {
    this.id = Objects.requireNonNull(id); this.subprocessId = Objects.requireNonNull(subprocessId); this.riskScopeId = Objects.requireNonNull(riskScopeId); this.controlScopeId = Objects.requireNonNull(controlScopeId);
  ...
  public static CentralSubprocessRiskControlCoverageEntity create(UUID id, UUID subprocessId, UUID riskScopeId, UUID controlScopeId, LocalDate validFrom, LocalDate validTo, UUID actorId, Instant now) { return new CentralSubprocessRiskControlCoverageEntity(id, subprocessId, riskScopeId, controlScopeId, validFrom, validTo, actorId, now); }
  ...
  public UUID getId() { return id; } public UUID getSubprocessId() { return subprocessId; } public UUID getRiskScopeId() { return riskScopeId; } public UUID getControlScopeId() { return controlScopeId; }
