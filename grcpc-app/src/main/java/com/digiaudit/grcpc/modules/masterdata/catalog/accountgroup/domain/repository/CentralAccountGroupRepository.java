...
public interface CentralAccountGroupRepository extends JpaRepository<CentralAccountGroupEntity, UUID> {
    List<CentralAccountGroupEntity> findByStatusNotOrderBySortOrderAscTitleAscIdAsc(MasterDataLifecycleStatus status);
    List<CentralAccountGroupEntity> findByStatusOrderBySortOrderAscTitleAscIdAsc(MasterDataLifecycleStatus status);
    List<CentralAccountGroupEntity> findAllByOrderByIdAsc();
    Optional<CentralAccountGroupEntity> findByIdAndStatusNot(UUID id, MasterDataLifecycleStatus status);
