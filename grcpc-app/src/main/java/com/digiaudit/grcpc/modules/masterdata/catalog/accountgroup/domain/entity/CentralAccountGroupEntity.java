...
public class CentralAccountGroupEntity extends CentralDefinitionEntity {
    ...
    private CentralAccountGroupEntity(UUID id, String code, String title, UUID parentAccountGroupId,
    ...
    public static CentralAccountGroupEntity create(UUID id, String code, String title, UUID parentAccountGroupId,
                                                    String description, int sortOrder, LocalDate validFrom,
                                                    LocalDate validTo, UUID actorId, Instant now) {
        return new CentralAccountGroupEntity(id, code, title, parentAccountGroupId, description, sortOrder,
    ...
    public void restoreFromCreate(String title, UUID parentAccountGroupId, String description, int sortOrder,
    ...
    public void reactivateFromCreate(String title, UUID parentAccountGroupId, String description, int sortOrder,
                                     LocalDate validFrom, LocalDate validTo, UUID actorId, Instant now) {
        this.parentAccountGroupId = parentAccountGroupId;
        this.sortOrder = sortOrder;
    ...
    public UUID getParentAccountGroupId() { return parentAccountGroupId; }
