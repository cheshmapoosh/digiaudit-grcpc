...
@Entity
@Table(name = "central_policy_group")
public class CentralPolicyGroupEntity extends CentralDefinitionEntity {
    ...
    protected CentralPolicyGroupEntity() {
    }

    private CentralPolicyGroupEntity(UUID id, String code, String title, UUID parentGroupId,
    ...
    public static CentralPolicyGroupEntity create(UUID id, String code, String title, UUID parentGroupId,
                                                   String description, int sortOrder, LocalDate validFrom,
                                                   LocalDate validTo, UUID actorId, Instant now) {
        return new CentralPolicyGroupEntity(id, code, title, parentGroupId, description, sortOrder,
    ...
    public void restoreFromCreate(String title, UUID parentGroupId, String description, int sortOrder,
    ...
    public void reactivateFromCreate(String title, UUID parentGroupId, String description, int sortOrder,
                                     LocalDate validFrom, LocalDate validTo, UUID actorId, Instant now) {
        this.parentGroupId = parentGroupId;
        this.sortOrder = sortOrder;
