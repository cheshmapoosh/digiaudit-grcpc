...
@RestController
@RequestMapping("/api/master-data/central/regulation-groups")
public class CentralRegulationGroupController {
  private final CentralRegulationGroupCommandService commands;
  private final CentralRegulationGroupQueryService queries;

  public CentralRegulationGroupController(
      CentralRegulationGroupCommandService c, CentralRegulationGroupQueryService q) {
    commands = c;
    queries = q;
  }
