...
public interface CentralPolicyGroupRepository
    extends JpaRepository<CentralPolicyGroupEntity, UUID> {
  List<CentralPolicyGroupEntity> findByStatusNotOrderBySortOrderAscTitleAscIdAsc(
      MasterDataLifecycleStatus status);

  List<CentralPolicyGroupEntity> findByStatusOrderBySortOrderAscTitleAscIdAsc(
      MasterDataLifecycleStatus status);

  List<CentralPolicyGroupEntity> findAllByOrderByIdAsc();

  Optional<CentralPolicyGroupEntity> findByIdAndStatusNot(
