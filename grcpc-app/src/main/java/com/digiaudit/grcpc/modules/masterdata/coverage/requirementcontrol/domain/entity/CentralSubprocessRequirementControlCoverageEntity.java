package com.digiaudit.grcpc.modules.masterdata.coverage.requirementcontrol.domain.entity;
...
@Entity
@Table(name = "central_subprocess_requirement_control_coverage")
public class CentralSubprocessRequirementControlCoverageEntity {
  ...
  @JdbcTypeCode(SqlTypes.BINARY) @Column(name = "requirement_scope_id", nullable = false, updatable = false, columnDefinition = "RAW(16)") private UUID requirementScopeId;
  ...
  protected CentralSubprocessRequirementControlCoverageEntity() {}
  private CentralSubprocessRequirementControlCoverageEntity(UUID id, UUID subprocessId, UUID requirementScopeId, UUID controlScopeId, LocalDate validFrom, LocalDate validTo, UUID actorId, Instant now) {
    this.id = Objects.requireNonNull(id); this.subprocessId = Objects.requireNonNull(subprocessId); this.requirementScopeId = Objects.requireNonNull(requirementScopeId); this.controlScopeId = Objects.requireNonNull(controlScopeId);
  ...
  public static CentralSubprocessRequirementControlCoverageEntity create(UUID id, UUID subprocessId, UUID requirementScopeId, UUID controlScopeId, LocalDate validFrom, LocalDate validTo, UUID actorId, Instant now) { return new CentralSubprocessRequirementControlCoverageEntity(id, subprocessId, requirementScopeId, controlScopeId, validFrom, validTo, actorId, now); }
  ...
  public UUID getId() { return id; } public UUID getSubprocessId() { return subprocessId; } public UUID getRequirementScopeId() { return requirementScopeId; } public UUID getControlScopeId() { return controlScopeId; }
