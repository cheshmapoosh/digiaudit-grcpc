...
@Entity
@Table(name = "central_control_group")
public class CentralControlGroupEntity extends CentralDefinitionEntity {
  ...
  protected CentralControlGroupEntity() {}

  private CentralControlGroupEntity(
      UUID id,
      String code,
      String title,
      UUID parentGroupId,
  ...
  public static CentralControlGroupEntity create(
      UUID id,
      String code,
      String title,
      UUID parentGroupId,
      ...
      UUID actorId,
      Instant now) {
    return new CentralControlGroupEntity(
