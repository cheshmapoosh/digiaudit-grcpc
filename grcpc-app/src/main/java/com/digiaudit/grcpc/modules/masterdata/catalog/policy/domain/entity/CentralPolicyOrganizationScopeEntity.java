...
@Entity
@Table(name = "central_policy_organization_scope")
public class CentralPolicyOrganizationScopeEntity {
  ...
  @JdbcTypeCode(SqlTypes.BINARY)
  @Column(name = "organization_id", nullable = false, updatable = false, columnDefinition = "RAW(16)")
  ...
  protected CentralPolicyOrganizationScopeEntity() {}
  public static CentralPolicyOrganizationScopeEntity create(UUID policyId, UUID organizationId,
      LocalDate validFrom, LocalDate validTo, UUID actor, Instant now) {
    CentralPolicyOrganizationScopeEntity row = new CentralPolicyOrganizationScopeEntity();
