...
public class CentralRegulationRequirementEntity extends CentralDefinitionEntity {
  ...
  private CentralRegulationRequirementEntity(
      UUID id,
      String code,
      String title,
      UUID regulationId,
  ...
  public static CentralRegulationRequirementEntity create(
      UUID id,
      String code,
      String title,
      UUID regulationId,
      ...
      UUID actorId,
      Instant now) {
    return new CentralRegulationRequirementEntity(
        id, code, title, regulationId, description, sortOrder, validFrom, validTo, actorId, now);
  }
