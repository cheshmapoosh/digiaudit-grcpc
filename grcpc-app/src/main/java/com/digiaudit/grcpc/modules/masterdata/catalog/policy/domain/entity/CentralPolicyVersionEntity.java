...
public class CentralPolicyVersionEntity {
    ...
    private CentralPolicyVersionEntity(UUID id, UUID policyId, int versionNumber, String content,
    ...
    public static CentralPolicyVersionEntity createDraft(UUID id, UUID policyId, int versionNumber, String content,
                                                          LocalDate validFrom, LocalDate validTo,
                                                          UUID actorId, Instant now) {
        return new CentralPolicyVersionEntity(id, policyId, versionNumber, content, validFrom, validTo, actorId, now);
    }

    public void updateDraft(String content, LocalDate validFrom, LocalDate validTo, UUID actorId, Instant now) {
        requireDraft();
        this.content = content;
        this.validFrom = validFrom;
        this.validTo = validTo;
    ...
    public PolicyVersionStatus getVersionStatus() { return versionStatus; }
