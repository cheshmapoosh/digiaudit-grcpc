...
public class CentralControlQueryService {
    ...
    public CentralControlQueryService(CentralControlRepository repository, CentralControlMapper mapper) {
    ...
    public CentralControlResponse detail(UUID id) {
        return repository.findByIdAndStatusNot(id, MasterDataLifecycleStatus.DELETED)
                ...
                .orElseThrow(() -> new NotFoundException("MASTER_DATA_NOT_FOUND", "error.masterdata.v2.notFound", "Control not found", id));
    }
}
