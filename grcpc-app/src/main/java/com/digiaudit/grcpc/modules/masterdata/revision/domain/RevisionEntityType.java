...
public enum RevisionEntityType {
  ...
  CENTRAL_CONTROL_GROUP("CENTRAL_CONTROL_GROUP", EnumSet.of(RevisionDomain.CENTRAL)),
  ...
  CENTRAL_SUBPROCESS_CONTROL_OBJECTIVE_SCOPE(
      "CENTRAL_OBJECTIVE_SCOPE", EnumSet.of(RevisionDomain.CENTRAL)),
  CENTRAL_SUBPROCESS_REQUIREMENT_SCOPE(
      "CENTRAL_REQUIREMENT_SCOPE", EnumSet.of(RevisionDomain.CENTRAL)),
  CENTRAL_POLICY_SUBPROCESS_SCOPE(
      "CENTRAL_POLICY_SUBPROCESS", EnumSet.of(RevisionDomain.CENTRAL)),
  CENTRAL_POLICY_ORGANIZATION_SCOPE(
      "CENTRAL_POLICY_ORG", EnumSet.of(RevisionDomain.CENTRAL)),
  CENTRAL_POLICY_CONTROL_SCOPE(
      "CENTRAL_POLICY_CONTROL", EnumSet.of(RevisionDomain.CENTRAL)),
  CENTRAL_POLICY_REQUIREMENT_SCOPE(
      "CENTRAL_POLICY_REQUIREMENT", EnumSet.of(RevisionDomain.CENTRAL)),
  CENTRAL_CONTROL_ACCOUNT_GROUP(
      "CENTRAL_CONTROL_ACCOUNT_GROUP", EnumSet.of(RevisionDomain.CENTRAL)),
  CENTRAL_CONTROL_OBJECTIVE_ACCOUNT_GROUP(
      "CENTRAL_OBJECTIVE_ACCOUNT_GROUP", EnumSet.of(RevisionDomain.CENTRAL)),
  CENTRAL_SUBPROCESS_RISK_CONTROL_COVERAGE(
      "CENTRAL_RISK_CONTROL_COV", EnumSet.of(RevisionDomain.CENTRAL)),
  CENTRAL_SUBPROCESS_RISK_CONTROL_OBJECTIVE_COVERAGE(
      "CENTRAL_RISK_OBJECTIVE_COV", EnumSet.of(RevisionDomain.CENTRAL)),
  CENTRAL_SUBPROCESS_CONTROL_CONTROL_OBJECTIVE_COVERAGE(
      "CENTRAL_CONTROL_OBJECTIVE_COV", EnumSet.of(RevisionDomain.CENTRAL)),
  CENTRAL_SUBPROCESS_REQUIREMENT_CONTROL_COVERAGE(
      "CENTRAL_REQUIREMENT_CONTROL_COV", EnumSet.of(RevisionDomain.CENTRAL)),
  ...
  LOCAL_SUBPROCESS_CONTROL_OBJECTIVE_SCOPE(
      "LOCAL_OBJECTIVE_SCOPE", EnumSet.of(RevisionDomain.LOCAL)),
  ...
  LOCAL_SUBPROCESS_RISK_CONTROL_COVERAGE(
      "LOCAL_RISK_CONTROL_COV", EnumSet.of(RevisionDomain.LOCAL)),
  LOCAL_SUBPROCESS_RISK_CONTROL_OBJECTIVE_COVERAGE(
      "LOCAL_RISK_OBJECTIVE_COV", EnumSet.of(RevisionDomain.LOCAL)),
  LOCAL_SUBPROCESS_CONTROL_CONTROL_OBJECTIVE_COVERAGE(
      "LOCAL_CONTROL_OBJECTIVE_COV", EnumSet.of(RevisionDomain.LOCAL)),
  LOCAL_SUBPROCESS_REQUIREMENT_CONTROL_COVERAGE(
      "LOCAL_REQUIREMENT_CONTROL_COV", EnumSet.of(RevisionDomain.LOCAL)),
  ...
  RevisionEntityType(String wireValue, Set<RevisionDomain> permittedDomains) {
    if (wireValue.length() > 32) {
      throw new IllegalArgumentException(
          "revision entity wireValue exceeds the documented 32 byte storage limit");
    }
  ...
  public static RevisionEntityType fromWireValue(String wireValue) {
    ...
    return Arrays.stream(values())
        ...
        .findFirst()
        .orElseThrow(
            () -> new IllegalArgumentException("Unknown revision entity type: " + wireValue));
  }
}
