...
function collectExpandableIds(nodes: PolicyTreeNode[]): Set<string> {
...
export default function PolicyTree({
    ...
    if (!items.length && !busy) {
        return (
            <MessageStrip design="Information" hideCloseButton>
                {t("policy.list.empty", {
                    defaultValue: "هیچ سیاستی ثبت نشده است.",
                })}
            </MessageStrip>
        );
    }
    ...
    return (
        ...
        >
            ...
            >
                <span>{t("policy.fields.name", { defaultValue: "نام" })}</span>
            ...
            <Tree
                accessibleName={t("policy.list.title", {
                    defaultValue: "ساختار سیاست",
                })}
