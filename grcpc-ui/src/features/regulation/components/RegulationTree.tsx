...
function collectExpandableIds(nodes: RegulationTreeNode[]): Set<string> {
...
interface RegulationTreeItemProps {
    node: RegulationTreeNode;
    selectedId?: string | null;
    expandedIds: Set<string>;
}

function RegulationTreeItem({ node, selectedId, expandedIds }: RegulationTreeItemProps) {
...
export default function RegulationTree({
        ...
        return (
            <MessageStrip design="Information" hideCloseButton>
                {t("regulation.list.empty", {
                    defaultValue: "هیچ قانون یا الزامی ثبت نشده است.",
                })}
            </MessageStrip>
        );
    }
    ...
    return (
        ...
        >
            ...
            >
                <span>{t("regulation.fields.name", { defaultValue: "نام" })}</span>
